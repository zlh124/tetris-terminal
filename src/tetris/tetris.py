...
class Tetris:
    ...
    x = 0b1101001010101000000
    y = 0b10010010000101010100
    r = 0b1101000010001010001
    c = 0b1010101000101000000
    p = 0b10010110010100010000

    px = 0b111100100001000000
    py = 0b11000011001000010000
    pr = 0
